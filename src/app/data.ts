...
export const projects = [
  ...
  },
  {
    ...
    content: [
      ...
      "Functionality for students includes adding annotations to course text/images, dictionary lookups of selected text, audio & video playback, and comprehension questions at the bottom of eachlesson.",
      `Educators can create & assemble different content types (richtext, images, videos, audio, questions) into a multi-page course, use a drag/drop interface to update layout/content placement, leverage other educators' shared course content, and view analytics data (mostly relating to question-response breakdown and video watching stats). Note: the product can be seen in action from a student's perspective at 1 minute 58 seconds into the linked video.`,
    ],
    photoUrl: "/imaginelearning-550x351-min.png",
    tags: ["react", "redux", "graphql"],
    callToAction: {
      label: "View product featured in video",
  ...
  },
  {
    ...
    content: `This is a version of an online fundraising application I created for Pigpile Corporation a few years back. The functionality basically mirrored that of the GoFundMe application but with a different business model.`,
